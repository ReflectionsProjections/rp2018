        ...
        <Grid.Row className='successContainer'>
          <Grid.Column mobile={14} computer={8} textAlign='center' verticalAlign='middle'>
            ...
            <Grid.Row className='successPrompt verticalPadding'>
              You have succesfully registered for Reflections | Projections! You should receive an email from us shortly with your <b>unique conference QR code</b>. Be sure to check your <b>spam folder</b>. Check our website for information on the schedule of events! If you have any questions, please email us at <a href='mailto:contact@reflectionsprojections.org'>contact@reflectionsprojections.org</a>
            </Grid.Row>
            <Grid.Row className='successPrompt verticalPadding'>
               Don't forget to register for the <a href="https://acmrp.org/symposium/register" target="_blank"><u>ACM Symposium</u></a>, <a href="https://acmrp.typeform.com/to/MR6XmN" target="_blank"><u>MechMania</u></a> or <a href="https://puzzlebang.com" target="_blank"><u>PuzzleBang</u></a>
            </Grid.Row>
            <Grid.Row className='verticalPadding'>
