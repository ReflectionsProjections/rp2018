      ...
      <Grid centered textAlign='center' verticalAlign='middle'>
        <Grid.Row className='startContainer'>
          <Grid.Column mobile={14} computer={8} textAlign='center' verticalAlign='middle'>
            ...
            <Grid.Row className='verticalPadding'>
              <Button size='medium' className="githubButton" href="https://api.reflectionsprojections.org/auth/google/?redirect_uri=https://reflectionsprojections.org/auth/?hasAuthorizationCode=true&isMobile=false">
                Login with Google    &#9658;
              </Button>
            </Grid.Row>
